	...
	return (
		<Section>
			...
			<div className="mt-[4rem]">
				<div className="flex flex-col justify-center align-center items-center gap-4 mb-12">
					...
					<TechStackGroup badgesAlign=" align-start" badges={["MySQL", "Codeigniter", "PHP"]} />
				</div>
				...
				<Card>
					<CardContent>
						...
						<div className="flex flex-col gap-4">
							<p>
								This system was developed during the final weeks of our Information Management 1 course while I was pursuing a Bachelor of Science in Information
								Technology at Bicol University. Our professor, Ma’am Mary Joy, randomly assigned topics using a spinning wheel, and our team landed on the Courier
								Information System. It was during the height of the COVID-19 pandemic, when face-to-face collaboration was limited. Many of my teammates were unable
								to contribute to the programming aspect due to hardware limitations, while others focused on documentation. We were given only a week of time for
								the development of the system. Given the circumstances, I took full ownership of the development process, as I had both the necessary equipment and
								the technical skills. With my prior experience in building information systems, I was confident—along with my team—that we could successfully excel
								in the course.
							</p>
